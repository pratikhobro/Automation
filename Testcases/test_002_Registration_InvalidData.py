...
def test_invalidateRegistration():
    ...
    register.enterFirstName('12345')
    register.enterLastName('!@#$%')
    
    register.enterBdMonth('Feb')
    register.enterBdDate('28')
    register.enterBdYear('2002')
    
    register.clickGender()
    
    register.enterMobile("98989898")
    
    register.enterPassword('Ram@1234==')
